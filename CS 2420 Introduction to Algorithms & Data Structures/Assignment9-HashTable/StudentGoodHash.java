...
public class StudentGoodHash {
	...
	/**
	 * This hashCode method for the StudentGoodHash represents a good distribution
	...
	public int hashCode() {
		...
		// Multiplies the inputs by a unique number to ensure a good distribution.
		for (int i = 0; i < this.firstName.length(); i++) {
			hashCode = (hashCode * 123 - this.firstName.charAt(i));

		}
		for (int i = 0; i < this.lastName.length(); i++) {
			hashCode = (hashCode * 124 + this.lastName.charAt(i));
		}
