...
public class StudentBadHash {
	...
	/**
	 * This hashCode method for the StudentBadHash represents a poor distribution of
	 * student objects in a hash table
	 * 
	 */
	public int hashCode() {
		int hashCode = 0;
		...
		// Only collects the total length of the inputs for clamping.
		hashCode = hashCode + uidString.length() + this.firstName.length() + this.lastName.length();
		return hashCode;
	}
}