...
public class LibraryGeneric<Type> {
	...
	public ArrayList<LibraryBookGeneric<Type>> lookup(Type holder) {
		...
		for (int i = 0; i < this.library.size(); i++) {
			...
			} else if (this.library.get(i).getHolder().equals(holder)) {
				checkedOutList.add(this.library.get(i));
			}
		}
	...
	public boolean checkout(long isbn, Type holder, int month, int day, int year) {
		...
		for (int i = 0; i < this.library.size(); i++) {
			if (this.library.get(i).getHolder() == null && this.library.get(i).getIsbn() == isbn) {
	...
	public ArrayList<LibraryBookGeneric<Type>> getOverdueList(int month, int day, int year) {
		...
		for (int i = 0; i < this.library.size(); i++) {
			...
			} else if (this.library.get(i).getDueDate().compareTo(today) < 0) {
				overdueList.add(this.library.get(i));
			}
		}
	...
	protected class OrderByDueDate implements Comparator<LibraryBookGeneric<Type>> {
		...
		public int compare(LibraryBookGeneric<Type> o1, LibraryBookGeneric<Type> o2) {
			return (o1.getDueDate().compareTo(o2.getDueDate()) > 0) ? 1
					: (o1.getDueDate().compareTo(o2.getDueDate()) < 0) ? -1 : 0;
		}
	}
	...
	protected class OrderByTitle implements Comparator<LibraryBookGeneric<Type>> {
		...
		@Override
		public int compare(LibraryBookGeneric<Type> o1, LibraryBookGeneric<Type> o2) {
			return (o1.getTitle().compareTo(o2.getTitle()) > 0) ? 1
					: (o1.getTitle().compareTo(o2.getTitle()) < 0) ? -1 : 0;
		}
	}
}