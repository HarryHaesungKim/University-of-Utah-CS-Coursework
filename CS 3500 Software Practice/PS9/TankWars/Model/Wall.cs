...
namespace Model
{
    ...
    public class Wall
    {
        ...
        /// <summary>
        /// Constructor for a wall object to be created, serialized, and sent to clients from the server.
        /// </summary>
        /// <param name="id"> The unique int ID of this wall. </param>
        /// <param name="p1"> An end point of this wall given as Vector2D object. </param>
        /// <param name="p2"> The other end point of this wall given as Vector2D object. </param>
