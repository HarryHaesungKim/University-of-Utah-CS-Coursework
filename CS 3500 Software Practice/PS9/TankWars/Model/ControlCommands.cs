...
namespace Model
{
    ...
    public class ControlCommands
    {
        ...
        /// <summary>
        /// Returns control commands for server.
        /// </summary>
        /// <returns> Control commands from client. </returns>
        public Tuple<string, string, Vector2D> GetControlCommands()
        {
            return new Tuple<string, string, Vector2D>(this.directionOfMovement, this.fire, this.aim);
        }
    }
}
