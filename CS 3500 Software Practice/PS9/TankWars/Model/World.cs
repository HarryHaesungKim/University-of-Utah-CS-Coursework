...
namespace Model
{
    ...
    public class World
    {
        ...
        private int size;
        // Keeps track of controls for each tank sent by clients to be processed.
        private Dictionary<int, ControlCommands> controlCommands;
        /// <summary>
        /// The size of this world given by the server.
        /// </summary>
        public int Size
        ...
        public World(int _size)
        {
            ...
            controlCommands = new Dictionary<int, ControlCommands>();
        }

        public Dictionary<int, ControlCommands> GetControls()
        {
